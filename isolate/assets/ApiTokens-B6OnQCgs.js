import{j as e,m as C}from"./framer-motion-Bv9FnYlZ.js";import{B as y}from"./badge-DV-hXy49.js";import{c as h,B as T}from"./button-Cc9JgH3A.js";import{C as l,a as f,b as j,c as v,d as p}from"./card-BwQo0Z2V.js";import{D as O,b as D,c as P,d as A,e as _}from"./dialog-C8RIqxzE.js";import{A as L,a as $,T as R,b as V,c as U,d as B,e as z,f as q,g as F,h as H}from"./alert-dialog-RC5fFf0A.js";import{I as J}from"./input-AaMFIBM9.js";import{L as M}from"./label-DfjaDQdD.js";import{p as K,q as G,s as Q,t as W}from"./radix-ui-DcvdO0Gu.js";import{C as k}from"./CopyButton-BphB2_1o.js";import{P as Y}from"./PageHeader-fIwNXlYk.js";import{d as Z,b as X,L as S,a as w,T as ee,t as g}from"./index-CjTTJCYC.js";import{c as N}from"./format-CUrzl6wJ.js";import{r as b}from"./react-vendor-CCjvE5q6.js";import{K as se}from"./key-round-Bon6qaqI.js";import{P as te}from"./plus-npPTblB0.js";import"./charts-CDRH5hBC.js";import"./x-CGEKlofu.js";import"./check-CkkU1U89.js";import"./copy-CWf2XDRa.js";function re({className:t,...s}){return e.jsx(K,{"data-slot":"tabs",className:h("flex flex-col gap-2",t),...s})}function ae({className:t,...s}){return e.jsx(G,{"data-slot":"tabs-list",className:h("bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",t),...s})}function c({className:t,...s}){return e.jsx(Q,{"data-slot":"tabs-trigger",className:h("data-[state=active]:bg-background dark:data-[state=active]:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30 text-foreground dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",t),...s})}function d({className:t,...s}){return e.jsx(W,{"data-slot":"tabs-content",className:h("flex-1 outline-none",t),...s})}function a({code:t,className:s}){return e.jsxs("div",{className:h("relative overflow-hidden rounded-lg border border-border bg-zinc-950",s),children:[e.jsx("div",{className:"absolute right-2 top-2 z-10",children:e.jsx(k,{value:t,label:"Code",variant:"ghost",size:"icon",className:"text-zinc-400 hover:bg-white/10 hover:text-zinc-100"})}),e.jsx("pre",{className:"max-h-[480px] overflow-auto p-4 font-mono text-[12px] leading-relaxed text-zinc-200",children:e.jsx("code",{children:t})})]})}const r="https://lovable-dove-890.convex.cloud".replace(/\.convex\.cloud$/,".convex.site")??"https://<deployment>.convex.site",ne=`// lib/nameserver.ts  — works in route handlers, server actions & client components
