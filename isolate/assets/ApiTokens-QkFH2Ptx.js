import{j as e}from"./framer-motion-DiNnH09Z.js";import{B as g}from"./badge-C0H1lq_1.js";import{c as h,B as C}from"./button-vFXXy3F_.js";import{C as l,a as f,b as j,c as v,d as p}from"./card-DYbWhX3_.js";import{D as I,b as O,c as D,d as P,e as A}from"./dialog-CS5DozV8.js";import{A as _,a as L,b as $,c as R,d as V,e as U,f as B,g as z,h as q}from"./alert-dialog-DK9zeU2c.js";import{L as F,I as H}from"./label-DB3CK22c.js";import{p as J,q as M,s as K,t as G}from"./radix-ui-CodNurnc.js";import{C as k}from"./CopyButton-DnI7FE1K.js";import{P as Q}from"./PageHeader-0ida6eV1.js";import{d as W,b as X,L as T,a as S,T as Y,t as y}from"./index-CQle4dHf.js";import{c as N}from"./format-CUrzl6wJ.js";import{r as b}from"./react-vendor-BsvDnyai.js";import{K as Z}from"./key-round-D0Ne_LPV.js";import{P as ee}from"./plus-DFTsuALt.js";import{T as se}from"./trash-2-AYA_iTdF.js";import"./charts-HwRvn74Q.js";import"./x-BYJ_8418.js";import"./check-CWKA_kFZ.js";function te({className:t,...s}){return e.jsx(J,{"data-slot":"tabs",className:h("flex flex-col gap-2",t),...s})}function re({className:t,...s}){return e.jsx(M,{"data-slot":"tabs-list",className:h("bg-muted text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px]",t),...s})}function c({className:t,...s}){return e.jsx(K,{"data-slot":"tabs-trigger",className:h("data-[state=active]:bg-background dark:data-[state=active]:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:outline-ring dark:data-[state=active]:border-input dark:data-[state=active]:bg-input/30 text-foreground dark:text-muted-foreground inline-flex h-[calc(100%-1px)] flex-1 items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:shadow-sm [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",t),...s})}function d({className:t,...s}){return e.jsx(G,{"data-slot":"tabs-content",className:h("flex-1 outline-none",t),...s})}function a({code:t,className:s}){return e.jsxs("div",{className:h("relative overflow-hidden rounded-lg border border-border bg-zinc-950",s),children:[e.jsx("div",{className:"absolute right-2 top-2 z-10",children:e.jsx(k,{value:t,label:"Code",variant:"ghost",size:"icon",className:"text-zinc-400 hover:bg-white/10 hover:text-zinc-100"})}),e.jsx("pre",{className:"max-h-[480px] overflow-auto p-4 font-mono text-[12px] leading-relaxed text-zinc-200",children:e.jsx("code",{children:t})})]})}const r="https://brave-lobster-493.convex.cloud".replace(/\.convex\.cloud$/,".convex.site")??"https://<deployment>.convex.site",ae=`// lib/nameserver.ts  — works in route handlers, server actions & client components
...
[ -n "$CONVEX_SITE" ] || CONVEX_SITE="https://panxcz.convex.site"
...
// val result = NameserverApi.connect("LIC-XXXX-XXXX-XXXX-XXXX-XXXX", "device-abc-123")`,de=`// udp-handshake.mjs — stage 2 after a successful /connect
