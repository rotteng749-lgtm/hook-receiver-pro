...
if echo "$RESPONSE" | grep -q '"ok":true'; then
  ...
  exit 1
fi`,le=`// NameserverApi.kt — dependencies: implementation("com.squareup.okhttp3:okhttp:4.12.0")
